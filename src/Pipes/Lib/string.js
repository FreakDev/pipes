...
export default {
     ...
     * @Pipe\param withString {String} - This pipe will output the input value concatenate with %s or (if left empty)
     * @Pipe\param withVar {Pipe|pipe-var} - the value from the box %s
     * @Pipe\param [isBefore] {Boolean} -  placed %s it
     */
    concat: function ({ withString, withVar, isBefore = false }, input) {
     ...
     * @Pipe\param stringValue {String} - Will output the character at inputed position from the string %s or (if left empty)
     ...
     * @Pipe\param stringValue {String} - Will output a sub-string of the string %s or (if left empty)
     * @Pipe\param varValue {Pipe|pipe-var} - the one from the box %s,
