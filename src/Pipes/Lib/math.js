...
export default {
     ...
     * @Pipe\param valueToAdd {Number} -
     * @Pipe\param getValueToAdd {Pipe|pipe-func} -
     */
     ...
     * @Pipe\param value {Number} - and %s as B or (if left empty)
     * @Pipe\param variable {Pipe|pipe-var} - the value from box labelled %s
     */
     ...
     * @Pipe\param value {Number} - %s or (if left empty)
     * @Pipe\param variable {Pipe|pipe-var} - the value in the %s box.
    ...
    compare: function ({ operator, value, variable, outputTrue, outputFalse }, input) {
        ...
        return result ? this.forward(outputTrue, input) : this.forward(outputFalse, input)
    },
     ...
     * @Pipe\name random
     * @Pipe\type pipe-native
     * @Pipe\param [from] {Number} - a
     * @Pipe\param [to] {Number} - a
     * @Pipe\param [inputAsMax] {Boolean} - (default false)
     */
